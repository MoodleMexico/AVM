...
ARCHIVO_RASPBIAN="2018-06-27-raspbian-stretch-lite"      # Nombre SIN extensión
...
wget -O wikipedia.zim http://download.kiwix.org/zim/wikipedia/wikipedia_es_all_novid_2018-04.zim
# Descarga Kiwix
